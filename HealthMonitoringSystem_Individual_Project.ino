...
char auth[]="zMYK_9JPlgOVymlO-8lVnkYYxqfD3JZS"; // Authentication code for Blynk app
char ssid[] = "Wifi";  // wifi ssid
char pass[] = "password"; // password for wifi
...
void sendSensor()
{
  ...
  if (!BPM.begin()) 
  {
    Serial.println("Could not find a valid BPM sensor, check wiring!");
    while (1) {}
  }

float pulse = dht.readPulse();
float temp = dht.readTemperature();

Blynk.virtualWrite(V5 , pulse);
...
const int sensorMax = 120; // sensor maximum, discovered through experiment
